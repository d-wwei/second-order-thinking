...
If First Principles or Tacit Knowledge is already in your `AGENTS.md`, place Second-Order Thinking AFTER them. Order:
1. Tacit Knowledge (output quality layer)
2. First Principles (reasoning input layer)
3. Second-Order Thinking (consequence depth layer)
